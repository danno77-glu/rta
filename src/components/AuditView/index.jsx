  ...
  import DataExport from '../DataExport'; // Import the DataExport component
  import './styles.css';
          ...
          <div className="header-actions">
            {isEditing ? (
              ...
              <>
                ...
                {/* Add the DataExport component here, conditionally rendered */}
                {audit && damageRecords && <DataExport audit={audit} damageRecords={damageRecords} />}
